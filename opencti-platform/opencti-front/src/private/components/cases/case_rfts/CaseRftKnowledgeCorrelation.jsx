...
export const caseRftKnowledgeCorrelationQuery = graphql`
  query CaseRftKnowledgeCorrelationQuery($id: String!) {
    caseRft(id: $id) {
      ...CaseRftKnowledgeCorrelation_case
    }
  }
`;

const caseRftKnowledgeCorrelationStixCoreObjectQuery = graphql`
  query CaseRftKnowledgeCorrelationStixCoreObjectQuery($id: String!) {
...
const caseRftKnowledgeCorrelationStixCoreRelationshipQuery = graphql`
  query CaseRftKnowledgeCorrelationStixCoreRelationshipQuery($id: String!) {
...
class CaseRftKnowledgeCorrelationComponent extends Component {
  constructor(props) {
    const LOCAL_STORAGE_KEY = `case-rfts-${props.caseData.id}-knowledge-correlation`;
    super(props);
  ...
  saveParameters(refreshGraphData = false) {
    const LOCAL_STORAGE_KEY = `case-rfts-${this.props.caseData.id}-knowledge-correlation`;
    saveViewParameters(
      this.props.navigate,
      this.props.location,
      LOCAL_STORAGE_KEY,
  ...
  savePositions() {
    ...
    commitMutation({
      mutation: caseRftMutationFieldPatch,
      variables: {
  ...
  handleCloseEntityEdition(entityId) {
    setTimeout(() => {
      fetchQuery(caseRftKnowledgeCorrelationStixCoreObjectQuery, {
        id: entityId,
      })
        .toPromise()
        .then((data) => {
  ...
  handleCloseRelationEdition(relationId) {
    setTimeout(() => {
      fetchQuery(caseRftKnowledgeCorrelationStixCoreRelationshipQuery, {
        id: relationId,
      })
        .toPromise()
        .then((data) => {
...
CaseRftKnowledgeCorrelationComponent.propTypes = {
...
const CaseRftKnowledgeCorrelation = createFragmentContainer(
  CaseRftKnowledgeCorrelationComponent,
  {
    caseData: graphql`
      fragment CaseRftKnowledgeCorrelation_case on CaseRft {
        id
        name

...
const incidentKnowledgeCorrelationStixCoreObjectQuery = graphql`
  query IncidentKnowledgeCorrelationStixCoreObjectQuery($id: String!) {
...
const incidentKnowledgeCorrelationStixCoreRelationshipQuery = graphql`
  query IncidentKnowledgeCorrelationStixCoreRelationshipQuery($id: String!) {
...
class IncidentKnowledgeCorrelationComponent extends Component {
  constructor(props) {
    const LOCAL_STORAGE_KEY = `case-incident-${props.caseData.id}-knowledge-correlation`;
    super(props);
  ...
  handleCloseEntityEdition(entityId) {
    setTimeout(() => {
      fetchQuery(incidentKnowledgeCorrelationStixCoreObjectQuery, {
        id: entityId,
      })
        .toPromise()
        .then((data) => {
  ...
  handleCloseRelationEdition(relationId) {
    setTimeout(() => {
      fetchQuery(incidentKnowledgeCorrelationStixCoreRelationshipQuery, {
        id: relationId,
      })
        .toPromise()
        .then((data) => {
...
IncidentKnowledgeCorrelationComponent.propTypes = {
...
const IncidentKnowledgeCorrelation = createFragmentContainer(
